...
const applyExtraSetup = () => {
    ...
    const {versions, courses, messages, qst_in_questionnaires, ans_in_versions, possible_answers,
        ...
        part_in_questionnaire.hasMany(qst_in_questionnaires,{foreignKey:"part_id", as: "questions_for_this_part", onDelete:'cascade'});
        ...
        // ans_selected_in_test.belongsTo(qst_in_questionnaires, {foreignKey:"question_id", as: "qst_in_questionnaire_idd", onDelete:'cascade'})
        // qst_in_questionnaires.hasMany(ans_selected_in_test, {foreignKey:"question_id", as:"answers_answered_for_question", onDelete:'cascade'})
